...
function showHelp() {
	...
	*/
	...
	$help .= "--dry_run – this will be used with the --file directive in case we want to run the script but not insert into the DB. All other functions will be executed, but the database won't be altered (I guess this is for you guys to test) \n";
